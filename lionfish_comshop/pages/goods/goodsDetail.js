...
Page({
    ...
    onLoad: function(e) {
        ...
        var i = wx.getStorageSync("community"), n = i && i.communityId || "";
        if (wx.showLoading(), n) console.log("step3"), d(), o.get_goods_details(e.id, i, n), 
        o.setData({
            community: i
        }); else {
            var t = {};
            if ("undefined" !== e.community_id && 0 < e.community_id && (t.communityId = e.community_id), 
            "undefined" !== s) {
                var a = s.split("_");
                e.community_id = a[2], t.communityId = e.community_id;
            }
            util.getCommunityInfo(t).then(function(t) {
                console.log("step1"), d(), o.get_goods_details(e.id, t, n);
            }).catch(function(t) {
                console.log("step4 新人"), "" != Object.keys(t) && o.addhistory(t, !0);
            });
        }
        function d() {
    ...
    get_goods_details: function(t) {
        var a = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "", f = arguments[2], p = this;
        ...
        a && (f = a.communityId), app.util.request({
            url: "entry/wxapp/index",
            data: {
            ...
            success: function(t) {
                ...
                var c = t.data, u = (c.is_supply, c.is_open_vipcard_buy), l = c.modify_vipcard_name, g = c.is_vip_card_member, m = c.modify_vipcard_logo;
                p.currentOptions = t.data.data.options, p.setData({
                ...
                var _ = 0;
                0 < (_ = 0 == e.over_type ? 1e3 * (e.begin_time - t.data.data.cur_time) : 1e3 * (e.end_time - t.data.data.cur_time)) && count_down(p, _);
                var h = t.data.data.goods.description;
                WxParse.wxParse("article", "html", h, p, 0, app.globalData.systemInfo);
            }
        });
    },
    ...
    openSku: function() {
        ...
        if (this.authModal()) {
            ...
            if (0 < n.length) {
                ...
                var f = this.data.goods, p = f.card_price || "0.00", y = {
                    canBuyNum: f.total,
                    spuName: f.goodsname,
                    actPrice: f.actPrice,
