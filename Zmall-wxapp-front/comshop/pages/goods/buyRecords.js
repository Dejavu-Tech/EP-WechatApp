var util = require("../../utils/util.js"), status = require("../../utils/index.js"), app = getApp(), buyClearTime = null;

function count_down(t, a) {
    var o = Math.floor(a / 1e3), e = o / 3600 / 24, i = Math.floor(e), s = o / 3600 - 24 * i, n = Math.floor(s), d = o / 60 - 1440 * i - 60 * n, r = Math.floor(d), u = o - 86400 * i - 3600 * n - 60 * r;
    if (t.setData({
        endtime: {
...
Page({
    ...
    load_buy_record: function() {
        var o = this, t = this.data.goods_id;
