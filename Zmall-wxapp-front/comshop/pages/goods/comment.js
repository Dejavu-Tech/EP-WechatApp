...
function count_down(t, a) {
    var o = Math.floor(a / 1e3), e = o / 3600 / 24, i = Math.floor(e), s = o / 3600 - 24 * i, n = Math.floor(s), d = o / 60 - 1440 * i - 60 * n, r = Math.floor(d), c = o - 86400 * i - 3600 * n - 60 * r;
    if (t.setData({
        endtime: {
...
Page({
    ...
    onLoad: function(e) {
        ...
        if (n) console.log("step3"), o(), d(); else {
            var a = {};
            void 0 !== e.community_id && 0 < e.community_id && (a.communityId = e.community_id), 
    ...
    addhistory: function(t) {
        var a = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], o = t.communityId;
    ...
    load_comment_list: function() {
        var t = this.data.goods_id, a = wx.getStorageSync("token"), e = this;
        !this.hasRefeshin && (e.hasRefeshin = !0, e.setData({
            loadMore: !0,
            tip: "加载中"
        }), app.util.request({
            url: "entry/wxapp/index",
            ...
            success: function(t) {
                if (0 == t.data.code) {
                    ...
                    var o = e.data.list.concat(a);
                    e.page++, e.hasRefeshin = !1, e.setData({
                        list: o,
                        loadMore: !1,
                        tip: ""
                    });
                } else 1 == t.data.code ? (1 == e.page && e.setData({
                    showData: 0
                }), e.setData({
                    loadMore: !1,
                    tip: "^_^已经到底了"
    ...
    authSuccess: function() {
        var t = this.goodId, a = wx.getStorageSync("community"), o = a && a.communityId || this.community_id || "";
        wx.redirectTo({
            url: "/lionfish_comshop/pages/goods/comment?id=" + t + "&community_id=" + o
        });
    },
    authModal: function() {
    ...
    addToCart: function(t) {
        if (this.authModal()) {
            var a = t.detail.formId, o = wx.getStorageSync("token");
            app.util.request({
    ...
    goOrder: function() {
        ...
        var t = wx.getStorageSync("token"), a = wx.getStorageSync("community"), i = e.data.goods_id, o = a.communityId, s = e.data.sku_val, n = e.data.cur_sku_arr, d = "", r = e.data.is_just_addcar;
        n && n.option_item_ids && (d = n.option_item_ids), app.util.request({
            ...
            success: function(t) {
                if (3 == t.data.code) wx.showToast({
                    ...
                    var a = t.data.msg, o = t.data.max_quantity || "";
                    0 < o && e.setData({
                        sku_val: o
                    }), wx.showToast({
                        title: a,
                    ...
                    if (1 == r) e.closeSku(), wx.showToast({
                        title: "已加入购物车",
                        image: "../../images/addShopCart.png"
                    }), app.globalData.cartNum = t.data.total, e.setData({
    ...
    selectSku: function(t) {
        var a = t.currentTarget.dataset.type.split("_"), o = this.data.sku, e = {
            name: a[3],
            id: a[2],
            index: a[0],
            idx: a[1]
    ...
    setNum: function(t) {
        var a = t.currentTarget.dataset.type, o = 1, e = 1 * this.data.sku_val;
    ...
    preview: function(t) {
        var a = t.currentTarget.dataset.index, o = t.currentTarget.dataset.idx;
        wx.previewImage({
            urls: this.data.list[a].images,
            current: this.data.list[a].images[o],
            fail: function(t) {
                wx.showToast({
                    title: "预览图片失败，请重试",
                    icon: "none"
