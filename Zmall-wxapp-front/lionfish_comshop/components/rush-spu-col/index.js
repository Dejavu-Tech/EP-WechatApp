var app = getApp(), t = require("../../utils/public"), status = require("../../utils/index.js");
...
Component({
    ...
    methods: {
        openSku: function() {
            this.data.needAuth ? this.triggerEvent("authModal") : (console.log("step1"), this.setData({
                stopClick: !0,
                disabled: !1
        ...
        addCart: function(t) {
            ...
            "plus" == t.type ? app.util.request({
                ...
                success: function(t) {
                    ...
                    } else status.indexListCarCount(s, t.data.cur_count), i.triggerEvent("changeCartNum", t.data.total), 
                    i.setData({
                ...
                success: function(t) {
                    3 == t.data.code ? wx.showToast({
                        ...
                        icon: "none",
                        duration: 2e3
                    }) : (status.indexListCarCount(s, t.data.cur_count), i.setData({
                        number: t.data.cur_count
                    }), i.triggerEvent("changeCartNum", t.data.total));
                }
            });
        }
    }
